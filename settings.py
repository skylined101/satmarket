...
#     "SSH_KEY_PATH":  "", # Local path to SSH key file, for key-based auth
     ...
     "VIRTUALENV_HOME":  "/root", # Absolute remote path for virtualenvs
     "PROJECT_NAME": "satmarket23", # Unique identifier for project
#     "REQUIREMENTS_PATH": "", # Path to pip requirements, relative to project
#     "GUNICORN_PORT": 8000, # Port gunicorn will listen on
#     "LOCALE": "en_US.UTF-8", # Should end with ".UTF-8"
     "LIVE_HOSTNAME": "sat-market.com", # Host for public site.
     "REPO_URL": "https://github.com/stephenmcd/cartridge.git", # Git or Mercurial remote repo URL for the project
